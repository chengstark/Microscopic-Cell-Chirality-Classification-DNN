...
train_set, valid_set = Dataset_3DCNN(data_path, train_list, train_label, selected_frames), \
                       Dataset_3DCNN(data_path, test_list, test_label, selected_frames)
...
# create model
cnn3d = CNN3D(img_x=img_x, img_y=img_y,
